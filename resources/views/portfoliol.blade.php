...
<head>
    ...
    <title>Fares Abu Ghassan — Web Developer</title>
...
<nav id="navbar">
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
        <div class="flex items-center justify-between h-16 lg:h-20">
            ...
            <a href="#hero" class="flex items-center gap-2 group">
                <span class="font-display text-xl text-cream font-semibold tracking-tight group-hover:text-gold transition-colors duration-300">F.AG</span>
                <span class="hidden sm:block w-px h-4 bg-edge mx-1"></span>
                <span class="hidden sm:block font-mono text-xs text-muted tracking-widest uppercase">Web Dev</span>
            </a>
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <a href="#clients"  class="nav-link text-base py-1" onclick="closeMobileMenu()">Clients</a>
        ...
        <a href="https://wa.me/905551234567" target="_blank" class="btn-primary self-start">Hire Me</a>
    </div>
</nav>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 pt-32 pb-24 lg:pt-40 lg:pb-32 w-full">
        <div class="max-w-5xl">
            ...
            <p class="hero-eyebrow hero-anim-1 mb-6">
                ✦ &nbsp;Web Developer &nbsp;·&nbsp; Laravel &nbsp;·&nbsp; Mersin, Turkey
            </p>
            ...
            <p class="hero-sub hero-anim-3 mb-12">
                I design and develop fast, elegant websites for restaurants, clinics, retail shops, and local businesses — turning your brand into a powerful online presence.
            </p>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                <h2 class="section-title reveal reveal-delay-1 mb-8">
                    Developer.<br>
                    <em class="font-display italic text-gold">Problem Solver.</em>
                </h2>
                <div class="space-y-5 reveal reveal-delay-2">
                    <p class="text-slate leading-relaxed font-light text-lg">
                        I'm <span class="text-light font-medium">Fares Abu Ghassan</span> — a web developer focused on building practical, high-performance websites that help local businesses grow online.
                    </p>
                    <p class="text-muted leading-relaxed">
                        My work is built on <span class="text-slate">Laravel</span> and <span class="text-slate">Tailwind CSS</span> — clean, maintainable code that looks great on every screen. I work closely with clients to understand their real business needs, then deliver results fast.
                    </p>
                    <p class="text-muted leading-relaxed">
                        Whether you need a full business website, a QR menu, or a campaign landing page — I get it done with precision and care.
                    </p>
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="bg-panel border border-edge rounded-lg p-8 relative z-10">
                        <div class="flex items-center gap-3 mb-8">
                            ...
                            <div>
                                <div class="text-light font-semibold text-sm">Fares Abu Ghassan</div>
                                <div class="text-muted text-xs font-mono">Web Developer</div>
                            </div>
                        </div>
                        <div class="space-y-3">
                            @php
...
<section id="work" class="py-28 lg:py-40">
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div class="grid lg:grid-cols-3 gap-6">
            ...
            {{-- Project 3: CasaForma Furniture --}}
            <div class="project-card reveal reveal-delay-3">
                <div class="project-img">
                    <div class="project-img-inner w-full h-52 flex items-center justify-center relative overflow-hidden" style="background: linear-gradient(135deg, #1a120a 0%, #2d1f0e 50%, #3d2b1a 100%);">
                        <div class="absolute inset-0 opacity-30" style="background-image: radial-gradient(circle at 50% 60%, rgba(200,169,110,.35), transparent 65%);"></div>
                        {{-- Decorative furniture silhouette --}}
                        <div class="absolute bottom-0 left-0 right-0 flex justify-center opacity-10">
                            <svg width="200" height="60" viewBox="0 0 200 60" fill="white">
                                <rect x="20" y="30" width="60" height="8" rx="2"/>
                                <rect x="25" y="38" width="8" height="22" rx="1"/>
                                <rect x="67" y="38" width="8" height="22" rx="1"/>
                                <rect x="30" y="10" width="50" height="20" rx="3"/>
                                <rect x="120" y="25" width="70" height="10" rx="2"/>
                                <rect x="120" y="35" width="10" height="25" rx="1"/>
                                <rect x="180" y="35" width="10" height="25" rx="1"/>
                            </svg>
                        </div>
                        <div class="text-center z-10">
                            <div class="font-display text-3xl text-white font-semibold tracking-wide">CasaForma</div>
                            <div class="font-mono text-xs tracking-widest uppercase mt-1.5" style="color:#c8a96e;">Premium Furniture</div>
                        </div>
                    </div>
                </div>
                <div class="p-6">
                    <div class="flex items-center gap-2 mb-3">
                        ...
                        <span class="project-tag">WhatsApp CTA</span>
                    </div>
                    <h3 class="text-light font-semibold text-xl mb-2">CasaForma Furniture</h3>
                    <p class="text-muted text-sm leading-relaxed font-light mb-5">A premium product catalog for a furniture showroom — chairs, tables, dining sets & café furniture. Elegant design with WhatsApp inquiry flow.</p>
                    <div class="flex items-center gap-3">
                        <a href="#" class="btn-primary text-xs py-2 px-4">Live Demo ↗</a>
                        <a href="#" class="btn-outline text-xs py-2 px-4">Details</a>
                    </div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div class="max-w-xl mb-16">
            ...
            <p class="text-muted mt-5 leading-relaxed font-light reveal reveal-delay-2">
                I specialize in fast, business-focused digital solutions for local businesses that want a strong online presence — without the agency price tag.
            </p>
        </div>
        ...
        $clientTypes = [
            ...
            [
                ...
                'desc'  => 'Any local business that needs a modern web presence fast.',
...
<section id="stack" class="py-28 lg:py-40">
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div class="max-w-xl mb-16">
            ...
            <h2 class="section-title reveal reveal-delay-1">My Stack</h2>
            <p class="text-muted mt-4 leading-relaxed font-light reveal reveal-delay-2">The technologies I use to build fast, robust, and maintainable web solutions.</p>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
                ...
                <h2 class="section-title reveal reveal-delay-1 mb-6">
                    Why Work<br>With <em class="font-display italic text-gold">Me?</em>
                </h2>
                <p class="text-muted leading-relaxed font-light reveal reveal-delay-2">I'm not a big agency. I'm a dedicated developer who cares about your results — not just delivering code and moving on.</p>
            </div>

            <div class="grid gap-4">
                @php
                $reasons = [
                    ['Fast Delivery', 'No long waits. I work efficiently and deliver within agreed timelines.'],
                    ...
                    ['Business-Focused', 'I build for results: more leads, more orders, more trust.'],
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div class="max-w-3xl mx-auto text-center mb-16">
            ...
            <p class="text-muted leading-relaxed font-light reveal reveal-delay-2">
                Have a project in mind? I'd love to hear about it. Reach out through any channel below and I'll get back to you within 24 hours.
            </p>
            {{-- Project request highlight --}}
            <div class="mt-8 reveal reveal-delay-3">
                <a href="https://wa.me/905551234567?text=Hi%20Fares%2C%20I%27d%20like%20to%20request%20a%20website%20for%20my%20business." target="_blank" class="btn-primary mx-auto text-sm py-4 px-8 inline-flex">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
                    </svg>
                    Request Your Project on WhatsApp
                </a>
                <p class="text-muted text-xs font-mono mt-4 opacity-60">or reach out through any channel below</p>
            </div>
        </div>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
            ...
            <a href="https://github.com/faresabughassan" target="_blank" class="contact-link reveal reveal-delay-2">
                ...
                <div>
                    ...
                    <div class="text-sm font-medium">View My Code</div>
                </div>
            </a>
            ...
            <a href="https://linkedin.com/in/faresabughassan" target="_blank" class="contact-link reveal reveal-delay-3">
                ...
                <div>
                    ...
                    <div class="text-sm font-medium">Connect With Me</div>
                </div>
            </a>

            <a href="/cdn-cgi/l/email-protection#f09691829583b09588919d809c95de939f9d" class="contact-link reveal reveal-delay-4">
...
<footer class="border-t border-edge py-10">
    <div class="max-w-7xl mx-auto px-6 lg:px-10 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div class="flex items-center gap-3">
            <span class="font-display text-lg text-cream">F.AG</span>
            <span class="text-edge">|</span>
            <span class="text-muted text-xs font-mono">Fares Abu Ghassan</span>
        </div>
