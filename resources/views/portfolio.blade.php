...
<nav id="navbar">
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
        <div class="flex items-center justify-between h-16 lg:h-20">
            ...
            <div class="hidden md:flex items-center gap-8">
                ...
                <a href="https://wa.me/905538604023" target="_blank" class="btn-primary text-xs py-2.5 px-5">
                    Hire Us
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <a href="https://wa.me/905538604023" target="_blank" class="btn-primary self-start">Hire Us</a>
    </div>
</nav>
            ...
            <div>
                ...
                <div class="space-y-5 reveal reveal-delay-2">
                    ...
                    <p class="text-muted leading-relaxed">
                        <span class="text-slate">We design and build websites, landing pages, stores, and mobile-first products that helps brands look better, work smarter, and gow faster.</span>
                    </p>
                    <p class="text-muted leading-relaxed">
                        Whether you need a full business website, a QR menu, or a campaign landing page — we build it with clarity, speed, and care.
                    </p>
                </div>
                    ...
                    <div class="bg-panel border border-edge rounded-lg p-8 relative z-10">
                        <div class="flex items-center gap-3 mb-8">
                            ...
                            <div>
                                ...
                                <div class="text-muted text-xs font-mono">Development / Technical Lead / Client Communication</div>
                            </div>
                        </div>
                        <div class="flex items-center gap-3 mb-8">
                            <div class="w-10 h-10 rounded-full bg-gold flex items-center justify-center text-ink font-bold text-lg font-display">N</div>
                            <div>
                                <div class="text-light font-semibold text-sm">N. Talep</div>
...
<section id="work" class="py-28 lg:py-40">
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div class="grid lg:grid-cols-3 gap-6">
            ...
            {{-- Project 1: PregoEducation --}}
            <div class="project-card reveal reveal-delay-1">
                <div class="project-img">
                    <div class="project-img-inner w-full h-52 flex items-center justify-center relative overflow-hidden" style="background: linear-gradient(135deg, #1a2e1a 0%, #164e16 50%, #0f6020 100%);">
                        <div class="absolute inset-0 opacity-20" style="background-image: radial-gradient(circle at 30% 50%, rgba(34,197,94,.3), transparent 60%);"></div>
                        <div class="text-center z-10">
                            <div class="text-4xl mb-2">📚</div>
                            <div class="font-display text-2xl text-white font-semibold">Prego</div>
                            <div class="font-mono text-xs text-green-400 tracking-widest uppercase mt-1">Education</div>
                        </div>
                    </div>
                </div>
                <div class="p-6">
                    ...
                    <h3 class="text-light font-semibold text-xl mb-2">Prego Education</h3>
                    <p class="text-muted text-sm leading-relaxed font-light mb-5">Learn about university education in Italy, scholarship opportunities, and equivalency recognized by the Turkish Higher Education Council (YÖK). Make your dreams come true with PREGO Education.</p>
                    <div class="flex items-center gap-3">
                        <a href="https://eduprego.com/" class="btn-primary text-xs py-2 px-4">visit ↗</a>
                        <a href="https://wa.me/905551234567" class="btn-outline text-xs py-2 px-4">Details</a>
                    </div>
                </div>
            </div>            {{-- Project 1: Almostafa  --}}
            <div class="project-card reveal reveal-delay-1">
                <div class="project-img">
                    <div class="project-img-inner w-full h-52 flex items-center justify-center relative overflow-hidden" style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%);">
                        ...
                        <div class="text-center z-10">
                            <div class="text-4xl mb-2">⚖</div>
                            <div class="font-display text-2xl text-white font-semibold">Almostafa</div>
                            <div class="font-mono text-xs text-blue-300 tracking-widest uppercase mt-1">Consulting</div>
                        </div>
                    </div>
                </div>
                <div class="p-6">
                    ...
                    <h3 class="text-light font-semibold text-xl mb-2">Almostafa Consulting</h3>
                    <p class="text-muted text-sm leading-relaxed font-light mb-5">We provide comprehensive legal and administrative services to Arabs and foreigners with accuracy, professionalism and speed of completion — from residency and visas to company formation and sworn translation..</p>
                    <div class="flex items-center gap-3">
                        <a href="https://almostafa.com/" class="btn-primary text-xs py-2 px-4">visit ↗</a>
                        <a href="https://wa.me/905551234567" class="btn-outline text-xs py-2 px-4">Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="project-card reveal reveal-delay-1">
                <div class="project-img">
                    <div class="project-img-inner w-full h-52 flex items-center justify-center relative overflow-hidden" style="background: linear-gradient(135deg, #0e3c5c 0%, #1e6fa7 50%, #2ec4b6 100%);">
                        <div class="absolute inset-0 opacity-20" style="background-image: radial-gradient(circle at 40% 60%, rgba(46,196,182,.3), transparent 60%);"></div>
                        <div class="text-center z-10">
                            <div class="text-4xl mb-2">🦷</div>
                ...
                <div class="p-6">
                    ...
                    <p class="text-muted text-sm leading-relaxed font-light mb-5">A clean, professional website for a modern dental clinic. Includes service pages, appointment CTA, and trust-building sections. with a modern design and responsive layout for all devices. </p>
                    <div class="flex items-center gap-3">
                        <a href="https://dentora-clinic-main-znbhhf.laravel.cloud/" class="btn-primary text-xs py-2 px-4">Live Demo ↗</a>
                        <a href="https://wa.me/905551234567" class="btn-outline text-xs py-2 px-4">Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="project-card reveal reveal-delay-3">
                <div class="project-img">
                    <div class="project-img-inner w-full h-52 flex items-center justify-center relative overflow-hidden" style="background: linear-gradient(135deg, #0d0d0a 0%, #1a1a12 50%, #2a2a1a 100%);">
                        ...
                        <div class="text-center z-10">
                            <div class="text-4xl mb-2">🪑</div>
                            <div class="font-display text-2xl text-white font-semibold">Mora</div>
                ...
                <div class="p-6">
                    <div class="flex items-center gap-2 mb-3">
                        <span class="project-tag">Mora</span>
                        <span class="project-tag">Furniture</span>
                    </div>
                    <h3 class="text-light font-semibold text-xl mb-2">Premium furniture Demo</h3>
                    ...
                    <div class="flex items-center gap-3">
                        <a href="https://al-thahabi-1.github.io/furniture-mora/" class="btn-primary text-xs py-2 px-4">Live Demo ↗</a>
                        <a href="https://wa.me/905538604023" class="btn-outline text-xs py-2 px-4">Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="project-card reveal reveal-delay-3">
                <div class="project-img">
                    <div class="project-img-inner w-full h-52 flex items-center justify-center relative overflow-hidden" style="background: linear-gradient(135deg, #0d0d0a 0%, #1a1a12 50%, #2a2a1a 100%);">
                        ...
                        <div class="text-center z-10">
                            <div class="text-4xl mb-2">🪑</div>
                            <div class="font-display text-2xl text-white font-semibold">Casaforma</div>
                            <div class="font-mono text-xs tracking-widest uppercase mt-1" style="color:#c8a96e;">Premium Furniture</div>
                        </div>
                    </div>
                </div>
                <div class="p-6">
                    <div class="flex items-center gap-2 mb-3">
                        <span class="project-tag">Casaforma</span>
                        <span class="project-tag">Furniture</span>
                    </div>
                    <h3 class="text-light font-semibold text-xl mb-2">Premium Chairs Demo</h3>
                    <p class="text-muted text-sm leading-relaxed font-light mb-5">A luxury product catalog page for a furniture brand. Editorial design, product showcase, and contact-to-order flow.</p>
                    <div class="flex items-center gap-3">
                        <a href="https://al-thahabi-1.github.io/casaforma/" class="btn-primary text-xs py-2 px-4">Live Demo ↗</a>
                        <a href="https://wa.me/905538604023" class="btn-outline text-xs py-2 px-4">Details</a>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-14 reveal reveal-delay-2">
            <div class="bg-panel border border-edge rounded-lg p-8 lg:p-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8" style="background: linear-gradient(135deg, rgba(200,169,110,.04) 0%, transparent 60%), var(--panel);">
                ...
                <div class="flex flex-col sm:flex-row gap-3 flex-shrink-0">
                    <a href="https://wa.me/905538604023?text=Hi%20Fares%2C%20I%27d%20like%20to%20discuss%20a%20web%20project." target="_blank" class="btn-primary whitespace-nowrap">
...
<section id="stack" class="py-28 lg:py-40">
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div class="max-w-xl mb-16">
            ...
            <h2 class="section-title reveal reveal-delay-1">Tools We Use</h2>
            <p class="text-muted mt-4 leading-relaxed font-light reveal reveal-delay-2">The tools we use to build modern websites, stores, and digital products for growing buisnesses.</p>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
                ...
                <p class="text-muted leading-relaxed font-light reveal reveal-delay-2"> We're a focused creative team that builds with care, speed, and real business intent.</p>
            </div>
...
<section id="contact" class="py-28 lg:py-40 relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
            ...
            <a href="https://github.com/Al-Thahabi-1" target="_blank" class="contact-link reveal reveal-delay-2">
